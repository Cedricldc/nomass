...
if(!function_exists('adios_custom_style')) {
  function adios_custom_style() {
    ...
    $header_logo_height = adios_get_opt('logo-height');
    ...
    if($customize) {
      $output .= (!empty($header_logo_width) || !empty($header_logo_height)) ? '.header .logo img {':'';
      $output .=  ($header_logo_width) ? 'width:'.esc_attr($header_logo_width).';':'';
      $output .=  ($header_logo_height) ? 'height:'.esc_attr($header_logo_height).';':'';
      $output .= (!empty($header_logo_width) || !empty($header_logo_height)) ? '}':'';

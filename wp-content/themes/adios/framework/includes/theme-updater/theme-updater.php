 ...
 *
 */
if ( ! function_exists( 'adios_pre_set_site_transient_update_themes' ) ) {
  function adios_pre_set_site_transient_update_themes( $updates ) {
  ...
  add_filter( 'pre_set_site_transient_update_themes', 'adios_pre_set_site_transient_update_themes' );
}

if ( ! function_exists( 'adios_admin_head' ) ) {
  function adios_admin_head() {
  ...
  add_action( 'admin_head', 'adios_admin_head' );
}
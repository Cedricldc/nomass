...
if (!class_exists('adios_Redux_Framework_config')) {
    ...
    class adios_Redux_Framework_config {
        ...
        public function setSections() {
            ...
            require get_template_directory() . '/framework/admin/options/shop.php';
            require get_template_directory() . '/framework/admin/options/auto-update.php';
...
//             require get_template_directory() . '/admin/options/_test.php';
            ...
            $theme_info .= '<p class="redux-framework-theme-data description theme-uri">' . esc_html__('<strong>Theme URL:</strong> ', 'adios') . '<a href="' . $this->theme->get('ThemeURI') . '" target="_blank">' . $this->theme->get('ThemeURI') . '</a></p>';
            $theme_info .= '<p class="redux-framework-theme-data description theme-author">' . esc_html__('<strong>Author:</strong> ', 'adios') . $this->theme->get('Author') . '</p>';
            $theme_info .= '<p class="redux-framework-theme-data description theme-version">' . esc_html__('<strong>Version:</strong> ', 'adios') . $this->theme->get('Version') . '</p>';
            $theme_info .= '<p class="redux-framework-theme-data description theme-description">' . $this->theme->get('Description') . '</p>';
            $tabs = $this->theme->get('Tags');
            if (!empty($tabs)) {
                $theme_info .= '<p class="redux-framework-theme-data description theme-tags">' . esc_html__('<strong>Tags:</strong> ', 'adios') . implode(', ', $tabs) . '</p>';
            }
            $theme_info .= '</div>';
            ...
            $this->sections[] = array(
                ...
                'title'     => esc_html__('Theme Information', 'adios'),
                'desc'      => esc_html__('<p class="description">More about our theme.</p>', 'adios'),
                'fields'    => array(
                    array(
                        'id'        => 'opt-raw-info',
                        'type'      => 'raw',
            ...
            if (file_exists(get_template_directory() . '/README.html')) {
                ...
                $tabs['docs'] = array(
                    'icon'      => 'el-icon-book',
                    'title'     => esc_html__('Documentation', 'adios'),
                    'content'   => nl2br(adios_read_file(get_template_directory(),'README.html'))
                );
            }
        }

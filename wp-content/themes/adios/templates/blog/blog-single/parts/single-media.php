...
<?php
  ...
  switch ($post_format) {
    ...
    $img_src        = wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), 'adios-big');
    ...
    case 'gallery':
          ...
          <?php foreach ($gallery as $item): ?>
            <figure>
              <?php if (isset($item['attachment_id'])):
                echo wp_get_attachment_image( $item['attachment_id'], 'adios-big', array('alt' => esc_attr($item['title'])) );
              endif; ?>
            </figure>
          <?php endforeach; ?>
      </div>
      ...
      <a href="<?php echo get_the_permalink(); ?>">
        <figure>
          <?php if(has_post_thumbnail()) { the_post_thumbnail('adios-big'); } ?>
        </figure>
      </a>
      <?php
      endif;
    ...
    default: ?>
      <figure>
        <?php the_post_thumbnail('adios-big'); ?>
      </figure>
    <?php
      break;
  }

...
switch (adios_get_post_opt('portfolio-layout')) {
  default:
  case 'one_column':
    $width_class  = 'wh-100';
    $image_size   = 'adios-large-hor';
    $filter_class = 'left-filter';
    break;

  case 'three_column':
    $width_class  = 'wh-30';
    $image_size   = 'adios-small-alt';
    $filter_class = 'center-filter';
    break;

  case 'four_column':
    $width_class  = 'wh-25';
    $image_size   = 'adios-small';
    $filter_class = 'center-filter';
    break;
            ...
            <?php
              ...
              while ($the_query -> have_posts()) : $the_query -> the_post();
                ...
                $args = array(
                  ...
                  'style'          => adios_get_opt('portfolio-layout')
                );

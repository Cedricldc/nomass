...
class animo_WP_Contact_Details_Widget extends WP_Widget
{
  function __construct()
  {
    $widget_ops = array('classname' => 'widget_contact_details', 'description' => esc_html__( 'Diplay Contact Details', 'animo-addons' ) );
    parent::__construct('contact-details', esc_html__( 'Animo: Contact Details', 'animo-addons' ), $widget_ops);
  ...
  function widget($args, $instance)
  {
    ...
    <ul>
      ...
      <li>
        <p><strong><?php echo esc_html__('Phone Numbers:', 'animo-addons'); ?></strong></p>
        <p><span><?php echo $instance['phone_no']; ?></span></p>
      </li>
      <?php endif; ?>
      <?php if(isset($instance['email'])): ?>
      <li>
        <p><strong><?php echo esc_html__('E-mail:', 'animo-addons'); ?></strong></p>
        <p><span><?php echo $instance['email']; ?></span></p>
      </li>
      <?php endif; ?>
      <?php if(isset($instance['hour'])): ?>
      <li>
        <p><strong><?php echo esc_html__('Business hours::', 'animo-addons'); ?></strong></p>
  ...
  function form( $instance ) {
    ...
    <p><label for="<?php echo esc_attr($this->get_field_id('phone_no')); ?>"><?php esc_html_e( 'Phone Number', 'animo-addons' ); ?></label>
    ...
    <p><label for="<?php echo esc_attr($this->get_field_id('email')); ?>"><?php esc_html_e( 'Email', 'animo-addons' ); ?></label>
    ...
    <p><label for="<?php echo esc_attr($this->get_field_id('hour')); ?>"><?php esc_html_e( 'Hour', 'animo-addons' ); ?></label>
